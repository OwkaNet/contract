...
The aim of our project is to convert crypto assets in users' existing exchanges accounts
into money that can be used in daily life within seconds with the highly secure Owka Mobile Application. 
Owka, with the infrastructure it has developed, allows users to get rid of the hassle of complex transactions 
on exchanges and use their assets comfortably.

//WebSite    :  https://owka.net
//Telegram   :  https://t.me/OwkaNet
//Twitter (X):  https://twitter.com/OwkaNet
//Instagram  :  https://instagram.com/OwkaNet
*/
...
contract OwkaNet is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;
  string private _name = "OWKA NETWORK";
  string private _symbol = "OWKA";
  uint8 private _decimals = 9;
  address payable public marketingWalletAddress = payable(0xC5C1E448B998F9E24A22398300157B216EF1115e); // Marketing Address
  address payable public DevelopmentWalletAddress = payable(0x37539dD538E77cC5e18e66781b19Ec22F6DAB0d4); // Development Address
